export default function LandingVariationA() {
  const html = `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Landing – Variation A: Clear Hierarchy</title>
  <style>
    :root {
      --pb-white: #FFFFFF;
      --pb-accent: #5C7E8F;
      ...
      --font-heading: clamp(19px, 2vw, 26px);
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    h1,h2,h3,h4,h5 { font-size: var(--font-heading); font-weight: 700; line-height: var(--line-heading); }
    ...
    .section-white .eyebrow { color: var(--pb-accent); }
    .section-accent .eyebrow { color: var(--pb-lightgrey); }
    ...
    .btn-primary-landing { background: var(--pb-grey); color: #fff; }
...
<section class="landing-section section-white">
  <div class="landing-section-inner">
    <span class="eyebrow">The Insight Gap</span>
...
<section class="landing-section section-accent">
  <div class="landing-section-inner">
    <span class="eyebrow">Why Use It</span>
...
<div class="landing-footer">
  ...
  return (
    <iframe
      ...
      title="Variation A – Clear Hierarchy"
    />
  );
}
